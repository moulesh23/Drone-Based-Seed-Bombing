...
static const uint32_t GPSBaud = 9600; //if Baud rate 9600 didn't work in your case then use 4800/9600
...
char auth[] = "0f2735c90d2249cbab0afc537f9cad7b";              //Your Project authentication key
char ssid[] = "redmi";                                       // Name of your network (HotSpot or Router name)
char pass[] = "1234567890987";                                      // Corresponding Password
